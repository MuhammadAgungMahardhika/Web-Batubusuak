...
@section('container')
    <section class="container-fluid p-4" id="Atraksi">
        <div class="row " style="padding-top: 100px;">
            <div class="col ">
                <h2 class="display-6 text-center text-secondary" style="font-family: 'Roboto', serif;">EVENT </h2>
            </div>
        </div>
        <hr>
                            ...
                            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <a href="" onclick="showDetailevent('1')" data-bs-toggle="modal" data-bs-target="#detailevent" style="color: #eaeaea;">
                ...
                <div class="col-9 my-4">
                    <div class="row ">
                        ...
                        <div class="col-md-3 mb-4 col-sm-6">
                            <!-- Awal atraksi -->
                            <a href="" onclick="showDetailEvent('{{ $event->id }}')" data-bs-toggle="modal" data-bs-target="#detailevent" style="color: #eaeaea;">
                                <div class="card cardEfek">
                                       @if(@isset($event->event_gallery->first()->url))
                                              <img src="images/{{ $event->event_gallery->first()->url }}" class="card-img">
                                       @endif
    ...
    <!-- Modal -->
    <div class="modal fade" id="detailevent" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index:9999;">
            ...
            function showDetailEvent(id) {
                $.ajax({
                    ...
                    success : function(response){
                        console.log()
                    let galleries =  response.event_gallery
                    let i = 0
